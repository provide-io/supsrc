...
class TestCLIRefactoring:
    ...
    def test_new_commands_exist(self) -> None:
        ...
        assert "tail" in result.output and ("follow" in result.output.lower() or "changes" in result.output.lower())
        
        # watch should be for interactive monitoring
        assert "watch" in result.output and ("interactive" in result.output.lower() or "dashboard" in result.output.lower())
    ...
    def test_new_watch_is_interactive_only(self) -> None:
        ...
        assert "interactive" in result.output.lower() or "ui" in result.output.lower() or "dashboard" in result.output.lower()
